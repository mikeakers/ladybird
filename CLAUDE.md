...
**YOU ARE IN: `ladybird/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ladybird/` (rig root) or other directories
...
**Your mail address:** `ladybird/polecats/rust`
**Your rig:** ladybird
**Your Witness:** `ladybird/witness`
...
| Ask Witness for help | `gt mail send ladybird/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ladybird/witness`) when:
...
```bash
gt mail send ladybird/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
